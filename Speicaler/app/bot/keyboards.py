...
def developer_menu():
    return kb([
        ...
        [btn("📨 طلبات استخدام Special", "access_requests")],
        [btn("🔗 رابط دخول مؤقت", "temp_invite")],
        [btn("🚫 تقييد من البوت", "bot_restrict")],
        [btn("🔐 قفل الخاص", "private_lock"), btn("🤬 قفل الشتم", "profanity_toggle")],
        [btn("👤 استثناء من قفل الخاص", "private_lock_add"), btn("🧹 إلغاء الاستثناء", "private_lock_remove")],
